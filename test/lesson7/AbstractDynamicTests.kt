...
abstract class AbstractDynamicTests {
    fun longestCommonSubSequence(longestCommonSubSequence: (String, String) -> String) {
        ...
        assertEquals("K K K", longestCommonSubSequence("Ku Klux Klan", "Kate's Kitten Kiosque"))
        assertEquals("ъЕъ", longestCommonSubSequence("ъЕъеъЕъеъ", "ъуЕыаъ"))
...
Наследник всех своих родных.
    ...
    fun longestIncreasingSubSequence(longestIncreasingSubSequence: (List<Int>) -> List<Int>) {
        ...
        assertEquals(
            listOf(2, 5, 8, 12, 59, 505),
            longestIncreasingSubSequence(listOf(2, 2, 2, 2, 2, 2, 2, 2, 5, 1, 5, 5, 8, 12, 59, 505))
        )
        assertEquals(
